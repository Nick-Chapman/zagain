...
--  | Save_target Target -- Z4
  ...
  | Set_window Arg
  | Show_status
  | Sound_effect Arg (Maybe (Arg,Arg))
  | Split_window Arg
  | Sread Arg Arg
  | Store Arg Arg
  | Storeb Arg Arg Arg
...
opArgs = \case
  ...
  Show_status -> do []
  Sound_effect arg Nothing -> do [arg]
  Sound_effect arg1 (Just (arg2,arg3)) -> do [arg1,arg2,arg3]
...
opTargetOpt = \case
  ...
  Sound_effect _arg _ -> do Nothing
