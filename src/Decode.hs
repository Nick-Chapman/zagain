...
decode zv op = case op of
  ...
  Code 245 [t1] -> Op.Sound_effect <$> arg t1 <*> pure Nothing
  Code 245 [t1,t2,t3] -> Op.Sound_effect <$> arg t1 <*> ((\x y -> Just (x,y)) <$> arg t2 <*> arg t3)
  Code 246 [t] -> Op.Read_char <$> arg t <*> target
  Code 247 [t1,t2,t3]
